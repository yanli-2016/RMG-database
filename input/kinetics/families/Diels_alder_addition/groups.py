...
entry(
    index = 3,
    label = "diene_benzene_out",
    group = 
"""
1 *3 C u0 p0 c0 {2,B} {6,B}
2 *4 C u0 p0 c0 {1,B} {3,B}
3 *5 C u0 p0 c0 {2,B} {4,B}
4 *6 C u0 p0 c0 {3,B} {5,B}
...
"""
L1: diene_out
    L2: diene_benzene_out
    L2: diene_pah_bay_out
    L2: diene_5ring_out
